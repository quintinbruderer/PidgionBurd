...
var Scoreboard = function(game) {
  ...
  this.startButton = this.game.add.button(this.game.width/2, 300, 'startButton', this.startPress, this);
...
Scoreboard.prototype.show = function (score) {
  ...
  if (medal) {
    ...
    emitter.start(false, 500, 500);
  }
  this.game.add.tween(this).to({y: 0}, 1000, Phaser.Easing.Bounce.Out, true);

};

Scoreboard.prototype.startPress = function () {
